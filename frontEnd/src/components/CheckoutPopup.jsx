...
import falbackImage from "../assets/unplugged.png"
...
const CheckoutPopup = ({ show, handleClose, cartItems, totalPrice }) => {
  ...
  const convertBase64ToDataURL = (base64String, mimeType = 'image/jpeg') => {
    if (!base64String) return falbackImage
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
    ...
    <div className="bg-white w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden">
      ...
      <form onSubmit={handleConfirm} className="flex flex-col max-h-[80vh]">
        ...
        <div className="flex gap-3 p-6 border-t">
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-medium hover:bg-blue-700 transition flex justify-center items-center"
          >
            {isSubmitting ? (
              <>
